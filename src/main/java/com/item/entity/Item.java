...
public class Item {
    ...
    public BigDecimal getRilancioMinimo() { return rilancioMinimo; }
    public void setRilancioMinimo(BigDecimal rilancioMinimo) { this.rilancioMinimo = rilancioMinimo; }
    
    public LocalDateTime getDataCreazione() { return dataCreazione; }
    public void setDataCreazione(LocalDateTime dataCreazione) { this.dataCreazione = dataCreazione; }
    
    public Boolean getInAsta() { return inAsta; }
    ...
    public String getGestoreUsername() { return gestoreUsername; }
    public void setGestoreUsername(String gestoreUsername) { this.gestoreUsername = gestoreUsername; }
}